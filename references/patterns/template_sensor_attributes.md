...
For sensors depending on external data sources (e.g., non-Home Assistant APIs or REST sensors), expose degradation state via attributes (see `references/patterns/integration_degradation.md`).
...
- `references/patterns/integration_degradation.md` — Degradation strategies
- `references/cookbooks/dtt_techniques.md` — Debugging with attributes
